...
export class AddroleCommand extends Command {
	...
	public async chatInputRun(interaction: Command.ChatInputInteraction) {
		...
		// declare constants
		const trixiconURL =
			'https://media.discordapp.net/attachments/462564425866412045/1035666899389919353/20210806_005557.jpg?width=466&height=466';
		// embed
		const embed = new MessageEmbed()
			.setFields(
				{
					name: 'Menu om rollen toe te voegen of te verwijderen',
					value: `Onderaan staan knoppen van rollen die je kan toevoegen als je het nog niet hebt.
                Je kan de rol verwijderen als je de rol al hebt.`,
				},
				{
					name: 'De rollen',
					value: `<@&1052027246799499315>, <@&1052027725864501279>, <@&1052027815542923294>
