...
import { Interaction, Client, ClientEvents, Snowflake, Message, AutocompleteInteraction, CommandInteraction, ContextMenuInteraction, ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, Collection, ApplicationCommand, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, Permissions, BaseCommandInteraction, TextBasedChannel, PermissionResolvable, ClientOptions, PermissionString, Guild, PartialDMChannel } from 'discord.js';
...
declare class PreconditionStore extends Store<Precondition> {
    ...
    chatInputRun(interaction: CommandInteraction, command: ChatInputCommand, context?: Precondition.Context): AsyncPreconditionResult;
    contextMenuRun(interaction: ContextMenuInteraction, command: ContextMenuCommand, context?: Precondition.Context): AsyncPreconditionResult;
