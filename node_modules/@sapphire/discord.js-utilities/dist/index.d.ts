...
declare type PaginatedMessageStopReasons = 'time' | 'idle' | 'user' | 'messageDelete' | 'channelDelete' | 'threadDelete' | 'guildDelete' | 'limit' | 'componentLimit' | 'userLimit';
...
declare class PaginatedMessage {
     ...
     */
    protected handleEnd(_: Collection<Snowflake, ButtonInteraction | SelectMenuInteraction>, reason: PaginatedMessageStopReasons): Promise<void>;
    /**
