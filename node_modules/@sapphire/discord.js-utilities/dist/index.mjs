...
import { Constants, Permissions, Message, GuildMember, MessageActionRow, Formatters, MessageEmbed, Intents, MessageButton, MessageSelectMenu, InteractionCollector } from 'discord.js';
...
var PaginatedFieldMessageEmbed = class extends PaginatedMessage {
  constructor() {
    super(...arguments);
    __publicField(this, "embedTemplate", new MessageEmbed());
